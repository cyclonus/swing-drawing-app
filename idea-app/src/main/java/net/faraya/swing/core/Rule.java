...
public class Rule extends JComponent implements ContextListener {
    ...
    private void setIncrementAndUnits() {
        if (isMetric) {
            units = (int)(((double)INCH / (double)IViewerConstants.DOTS_PER_CENTIMETER) * scale);
            increment = units;
        } else {
            units = INCH;
            increment = (int)((units / 2) * scale);
        }
        // TODO: Prevent DivisionByZeroException
    }
